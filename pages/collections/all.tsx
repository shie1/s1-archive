...
const Library: NextPage = (props: any) => {
    ...
    return (<>
        <Head>
            ...
            {/* Facebook Meta Tags */}
            <meta property="og:url" content="https://archv.shie1bi.hu/collections/all" />
            ...
            <meta property="twitter:url" content="https://archv.shie1bi.hu/collections/all" />
...
Library.getInitialProps = async () => {
    return {
        collections: await apiCall("GET", `${process.env.NODE_ENV === "development" ? "http://localhost:3000" : "https://archv.shie1bi.hu"}/api/collections/all`)
    }
}
